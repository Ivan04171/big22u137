...
bot = telebot.TeleBot('7442095029:AAFQFl6ADV1qlRInC-aphcDgfsr9LHEbomY')
...
def welcome(message):
    ...
    bot.send_message(message.chat.id, '<b>Генератор Рандома Активирован</b> ', parse_mode='html', reply_markup=markup)
